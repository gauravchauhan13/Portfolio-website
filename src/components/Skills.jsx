    ...
    >
      ...
      >
        <div className="text-center mb-5">
          <h2
            className="fw-bold mb-3 skills-title"
          ...
          <p
            className="text-secondary fs-5 mx-auto skills-description"
            style={{
              maxWidth: "600px",
        ...
        <div className="d-flex justify-content-center mb-5">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(33, 38, 45, 0.8), rgba(33, 38, 45, 0.6))",
              ...
              {Object.keys(skillCategories).map((category, index) => (
                <button
                  ...
                  style={{
                    ...
                    transform:
                      activeCategory === category ? "scale(1.02)" : "scale(1)",
                    boxShadow:
                      activeCategory === category
            ...
            {skillCategories[activeCategory].map((skill, index) => (
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(33, 38, 45, 0.9), rgba(48, 54, 61, 0.7))",
                    border: "1px solid rgba(88, 166, 255, 0.2)",
                    backdropFilter: "blur(10px)",
                    transition:
                      "all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.background =
                      "linear-gradient(135deg, rgba(88, 166, 255, 0.1), rgba(124, 58, 237, 0.1))";
                  }}
                  onMouseLeave={(e) => {
