...
import { FaGithub, FaLinkedin, FaCode, FaDownload, FaEnvelope, FaCircle } from 'react-icons/fa';
    ...
    >
      ...
      <div className="container position-relative" style={{ zIndex: 2 }} data-aos="fade-up">
        ...
        <p className="lead text-secondary mb-5 mx-auto" style={{ maxWidth: '600px' }}>
          ...
          Currently a B.Tech Computer Science student at UPES, learning new technologies and working on projects.
        </p>
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
            <a
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = '0 15px 35px rgba(88, 166, 255, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = '0 10px 30px rgba(88, 166, 255, 0.3)';
              }}
              onFocus={(e) => {
        ...
        <div className="d-flex flex-wrap justify-content-center gap-3 mb-5">
          {[
            { icon: <FaGithub size={24} />, url: "https://github.com/SU-Gaurav", label: "GitHub Profile" },
            { icon: <FaLinkedin size={24} />, url: "https://www.linkedin.com/in/gaurav-chauhan-58474934a/", label: "LinkedIn Profile" },
            { icon: <FaEnvelope size={24} />, url: "mailto:gauravchauhan2318@gmail.com", label: "Send Email" },
            { icon: <SiLeetcode size={24} />, url: "https://leetcode.com/u/SU_Gaurav/", label: "LeetCode Profile" }
          ].map((social, index) => (
            <a
              key={index}
              href={social.url}
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = '0 10px 25px rgba(88, 166, 255, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.target.style.backgroundColor = 'transparent';
